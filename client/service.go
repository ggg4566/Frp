...
func (cm *ConnectionManager) realConnect() (net.Conn, error) {
	...
	if protocol == "websocket" {
		protocol = "tcp"
		dialOptions = append(dialOptions, libdial.WithAfterHook(libdial.AfterHook{Hook: frpNet.DialHookWebsocket(cm.cfg.WebSocketPath, cm.cfg.WebSocketHost)}))
	}
