...
type ClientCommonConf struct {
	...
	// CryptoSalt specifies the salt encrypted by the client
	CryptoSalt string `ini:"crypto_salt" json:"crypto_salt"`
	...
	// Specifies the Host Header for the WebSocket connection
...
func (cfg *ClientCommonConf) Complete() {
	...
	if cfg.CryptoSalt != "" {
		crypto.DefaultSalt = cfg.CryptoSalt
